...
@Component({
  ...
  templateUrl: './candidato-own-update.component.html'
})
export class CandidatoOwnUpdateComponent implements OnInit {
  isSaving: boolean;
  ...
  updateForm(candidato: ICandidato) {
      this.statoId = candidato.stato.id;
    ...
    this.editForm.patchValue({
        ...
        statoregistrazioneId: candidato.stato.descrizione
    });
  }
